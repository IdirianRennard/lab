...
?>
<form action='rest_payments_list-test.php' method='post'>
  <table class='table'>
    <tr><td>Client ID:</td>
    ...
    <tr><td><br></td></tr>
    <tr>
      <td>How Many Transactions would you like?</td>
      <td></td>
      <td><input name='count' type='number' min='1' max='20' placeholder="  10" size='4' required></td>
      <td></td>
      <td colspan="42">(Minimum 1 and Maximum 20)</td>
    </tr>
    <tr><td><br></td></tr>
    <tr>
      <td>Enviroment</td>
