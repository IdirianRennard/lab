...
?>
<br>
<form action='gettransactiondetials-test.php' method='post'>
<table class='table'>
  <tr>
    <td>API Username</td>
  ...
  <tr><td><br></td></tr>
  <tr>
    <td>Transacation ID:</td>
    <script>spaces(4)</script>
    <td><input type='text' class='drop' name='TRANSACTIONID' placeholder="Transacation ID" required></td>
  </tr>
  <tr><td><br></td></tr>
  <tr>
    <td>Enviroment:</td>
